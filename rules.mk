...
# compile includes into compiler flag
CFLAGS += $(addprefix -I,$(INC))

#LDFLAGS += $(CFLAGS) -fshort-enums -Wl,-T,$(TOP)/$(LD_FILE) -Wl,-Map=$@.map -Wl,-cref -Wl,-gc-sections
LDFLAGS += $(CFLAGS) -fshort-enums -Wl,-T,$(LD_FILE) -Wl,-Map=$@.map -Wl,-cref -Wl,-gc-sections
...
# Verbose mode
ifeq ("$(V)","1")
$(info SRC_S  $(SRC_S) ) $(info )
$(info SRC_C  $(SRC_C) ) $(info )
